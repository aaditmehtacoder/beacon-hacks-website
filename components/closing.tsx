  ...
  return (
    <section className="relative overflow-hidden border-t border-line bg-band py-28 text-band-ink sm:py-36">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 size-[44rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,var(--glow-closing),transparent_62%)] blur-xl" />
      </div>
